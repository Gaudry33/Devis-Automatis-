...
def main():
    chemin_modele = "modele_facture_accompte.docx"
    ...
    remplacements["<<T1>>"] = f"{total_ht:.2f}"
    remplacements["<<T2>>"] = f"{total_ht:.2f}"
    ...
    fichier_sortie = "Factures accompte finales/Facture_Acompte_Générée.docx"
